...
.role-admin { background-color: var(--color-danger); color: white; border: 2px solid var(--color-border); }
.role-gamemaster { background-color: var(--color-secondary); color: white; border: 2px solid var(--color-border); }
.role-spieler { background-color: var(--color-secondary); color: white; border: 2px solid var(--color-border); }
