      ...
      <div class="detail-top">
        ...
        <div class="detail-info">
          ...
          <div class="detail-actions">
            <button
              v-if="auth.isGameMaster"
              class="play-btn"
              :disabled="creating"
              @click="createLobby"
            >
              {{ creating ? 'Wird erstellt...' : 'Lobby erstellen' }}
            </button>
            <RouterLink v-else-if="!auth.isLoggedIn" to="/login" class="play-btn">
...
async function createLobby() {
  ...
  try {
    ...
    createError.value = e instanceof Error ? e.message : 'Lobby-Erstellung fehlgeschlagen';
  } finally {
